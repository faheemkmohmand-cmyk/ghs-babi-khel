        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl">
          ...
          {searchParams.error && (
            <div className="bg-red-50 border-2 border-red-200 rounded-xl p-3 mb-4">
              <p className="text-red-700 text-sm font-bold">❌ {searchParams.error}</p>
            </div>
          )}
          ...
          <form action="/auth/login" method="POST" className="space-y-4">
            ...
            <button type="submit"
              className="w-full bg-green-900 hover:bg-green-950 text-white font-bold py-3.5 rounded-xl transition-all text-base">
              🚀 Sign In
            </button>
          </form>
